        ...
        currentRoom ? (
          <div className="chat-panel">
            <div className="messages">
              {
                messages.map((message) => (
                  <div key={message.id}>
                    ...
                    { message.contentType == "map" ?
                      <Map latitude={message.latitude} longitude={message.longitude} /> : null
                    }
                  </div>
                ))
              }
            ...
            <div className="chatbar">
              ...
              <button className="share-location-button" onClick={shareLocation}>Share Location</button>
